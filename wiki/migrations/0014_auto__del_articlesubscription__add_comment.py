...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('wiki_comment', (
            ...
            ('text', self.gf('django.db.models.fields.TextField')(default='comment')),
        ))
        db.send_create_signal('wiki', ['Comment'])
    ...
    def backwards(self, orm):
        ...
        db.create_table('wiki_articlesubscription', (
            ...
            (u'subscription_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['django_notify.Subscription'], unique=True)),
        ))
        db.send_create_signal('wiki', ['ArticleSubscription'])

        # Deleting model 'Comment'
        db.delete_table('wiki_comment')
    ...
    models = {
        ...
        'wiki.comment': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'text': ('django.db.models.fields.TextField', [], {'default': "'comment'"})
        },
        'wiki.image': {
