...
CAN_READ = getattr(django_settings, 'WIKI_CAN_READ', True)
...
# team112 extension
# Comments permissions start here: 
CAN_COMMENT = getattr(django_settings, 'WIKI_CAN_COMMENT', None)

# team112 extension
# 
CAN_READ_COMMENT = getattr(django_settings, 'WIKI_CAN_READ_COMMENT', True)

# team112 extension
# 
CAN_DELETE_COMMENT = getattr(django_settings, 'WIKI_CAN_DELETE_COMMENT', None)
...
SEARCH_VIEW = getattr(
    django_settings,
    'WIKI_SEARCH_VIEW',
    'wiki.views.article.SearchView' if not 'haystack' in django_settings.INSTALLED_APPS
    else
